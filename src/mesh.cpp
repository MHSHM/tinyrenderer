...
inline static void
_load_mesh(Resource* resource, Resource_Manager* resources_manager, const std::string& path)
{
    objl::Loader loader;
    ...
    resources_manager->resources_map[path] = mesh;
}

inline static void
_free_mesh(Resource* resource, Resource_Manager* resources_manager, const std::string& path)
{
    Mesh* mesh = (Mesh*)resource;
    delete mesh;
    resources_manager->resources_map[path] = nullptr;
}
